...
const char* messages[] = {"Workshop 88 at CNS Mini Maker Faire!", "Good Morning!","I need a Pop","BURP BURP BURP","Lunch Time!!! Nom Nom Nom","Please Don\'t Hack Me","Applause","Dinner Time!!! Nom Nom Nom","See you at THOTCON 0x5","c7five was here."};
...
void loop()
{
   ...
   int rcv = 0;
   // msg
   scrollMessage(messages[0]);
   for (i = 0; i< 10; i++)
     {
       displayAnim(i);
     }
   
   // iter thru achievements
/*
   if (f_wdt == 1)
   {              
      f_wdt = 0;  

%define         docver 2013.04.13
%define         libver 2013.04.13
Name:           kicad
Version:        2013.04.19
Release:        1.r4011%{?dist}.PWR
Summary:        Schematic diagram and printed circuit board design

Group:          Applications/Engineering
License:        GPLv2+
URL:            bazaar.launchpad.net/~kicad-stable-committers_kicad_stable-r4011.tgz

# Source files created from upstream's bazaar repository
# bzr export -r 4010 kicad-2013.04.10
# bzr export -r 237 kicad-libraries-2013.04.13
# bzr export -r 427 kicad-doc-2013.04.13
...
Source10:       kicad-download.txt

Patch10:        %{name}-%{version}-real-version.patch
Patch11:        kicad-use-system-boost.patch
# PWR 042012 - error in PCB calculator bitmap
Patch100:       kicad-pcb_dialog.patch
...
%prep
%setup -n kicad-2013.04.19 -a 1 -a 2 -a 6 -a 7

%patch10 -p1 -b .real-version
%patch11 -p1 -b .boost-sys
%patch100 -p1 -b .bitmap
...
%{__rm} -rf %{buildroot}%{_datadir}/%{name}/template/CMakeFiles
...
%{__mv} -f  %{buildroot}%{_docdir}/%{name}/scripts %{buildroot}%{_datadir}/%{name}
...
%{_datadir}/%{name}/demos/*
%{_docdir}/%{name}/presentations/*
%{_docdir}/%{name}/tutorials/*

%changelog
* Sat Apr 20 2013 Paul Reich <reichp@att.net> 1.r4011%{?dist}.PWR
- Rebuilt for FC18 NO LTO, no NLS

* Tue Jan 9 2013 Paul Reich <reichp@att.net> 2012.11.15-2.r3804.PWR
- Split component libraries into separate package.
